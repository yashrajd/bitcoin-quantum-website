...
<template>
  <PageContainer>
    ...
    <h2>Key Features</h2>
    <ul>
      <li>Removes key-path spend feature from Taproot</li>
      <li>Signature scheme agnostic</li>
      <li>Soft fork design for backward compatibility</li>
...
ul { color: var(--text-secondary); padding-left: var(--space-5); line-height: 1.8; }
